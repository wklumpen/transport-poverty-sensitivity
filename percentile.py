...
PERCENTILE_RANGES = range(1, 101, 1)
...
for region in REGIONS:
    ...
    for tod in TODS:
        ...
        for p in PERCENTILE_RANGES:
            ...
            poverty_line = ec.weighted_quantile(ACCESS_COLUMN, quantile=p / 100)[
                "B03002_001E"
            ]
...
out.to_csv("../data/percentile.csv", index=False)

poverty_df = pd.DataFrame(poverty_lines)
poverty_df.to_csv("../data/percentile_lines.csv", index=False)
